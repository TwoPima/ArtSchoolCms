...
<div id="header">
	<div class="top"></div>
		...
		<div class="logo_sousuo">
			<div class="logo">
				<a href="__APP__"><img src="__ROOT__/statics/index/Image/logo.png"></a><!-- <?php echo ($set["site_logo"]); ?> -->
			</div>
			<div class="sousuo">
				<form class="sousuo_form" name="searchform" action="__APP__/Index/search" method="post">
						<input class="newinput" type="text" name="word">
					 	<input class="sub_input" type="submit" name="search"  value="搜索" />
			...
			<div class="nav">
				<ul>
				 <?php if(is_array($article_cate_list['parent'])): $i = 0; $__LIST__ = $article_cate_list['parent'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li style="width:10%"><a href="__APP__/Submenu/showFirstMenu?id=<?php echo ($val["id"]); ?>&pid=<?php echo ($val["id"]); ?>"><?php echo ($val["name"]); ?></a>
						 <ul>
							<?php if(is_array($article_cate_list['sub'][$val['id']])): $i = 0; $__LIST__ = $article_cate_list['sub'][$val['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sval): $mod = ($i % 2 );++$i; if($sval["in_site"] == '1'): ?><li id=""><a  target="_self" href="<?php echo ($sval["url"]); ?>"><?php echo ($sval["name"]); ?></a></li>
							<?php else: ?>
							<li id=""><a  target="_self" href="__APP__/Submenu/index?id=<?php echo ($sval["id"]); ?>&pid=<?php echo ($val["id"]); ?>"><?php echo ($sval["name"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
						 </ul>
...
<div id="photochange_importantnews">
	...
	<!-- 图片轮换开始 -->
			...
			<div class="importantnews">
				<h1>重要通知 </h1>
					 <ul>
				 		<?php if(is_array($Notice)): $i = 0; $__LIST__ = $Notice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a href="__APP__/Notice/detail?mo=Notice&id=<?php echo ($val["id"]); ?>&type=<?php echo ($val["type"]); ?>"><span><?php echo (date("m-d",$val["add_time"])); ?></span><?php echo (msubstr($val["name"],0,20,'utf-8',true)); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ul> 
...
<div id="focus_collegenews">
	<div class="container">
		...
		<div class="collegenews">
				<h1>学院新闻</h1>
					 <ul>
					 	<?php if(is_array($CollegeNotice)): $i = 0; $__LIST__ = $CollegeNotice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a href="__APP__/Notice/detail?mo=Notice&id=<?php echo ($val["id"]); ?>&type=<?php echo ($val["type"]); ?>"><span>【<?php echo (date("m-d",$val["add_time"])); ?>】</span><?php echo (msubstr($val["name"],0,20,'utf-8',true)); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
						</ul> 
			...
			<?php if(is_array($Department)): $i = 0; $__LIST__ = $Department;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="office_main">
						<a href="__APP__/Department/index?id=<?php echo ($val["id"]); ?>&mo=Article">
							...
							<div class="office_main_content">
									<h4>&nbsp;<?php echo ($val["alias"]); ?></h4>
									<p style="font-size:14px;"><?php echo (msubstr($val["intro"],0,60,'utf-8',true)); ?>
									</p>
							</div>
						</a>
...
<div id="discipline">
	<div class="container">
		...
		<?php if(is_array($Profession)): $i = 0; $__LIST__ = $Profession;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="office_main">
					<a href="__APP__/Profession/index?pid=<?php echo ($val["id"]); ?>">
						<div class="office_main_photo">
						...
						<div class="office_main_content">
								<h4>&nbsp;<?php echo ($val["name"]); ?></h4>
								<p style="font-size:14px;"><?php echo (msubstr($val["intro"],0,60,'utf-8',true)); ?></p>
						</div>
					</a>	
				</div><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>			   				   	
						  ...
						  <div id="footer_main_friend_link_title" class="footer_main_friend_link_title">
						   ...
						   <div id="footer_main_friend_link_con" class="footer_main_friend_link_con">
						   	...
						   	<div class="mod" style="display:none;">
						   		<span class="mod_pad">
						   			<span class="mod_pad_left">
						   				联系人:<?php echo ($set["site_name"]); ?><br>
							   			联系电话:<?php echo ($set["tel"]); ?><br>
							   			联系邮箱:<?php echo ($set["mail_username"]); ?><br>
							   			联系地址:<?php echo ($set["address"]); ?><br>
						   			</span>
						   			<span class="mod_pad_right">
						   				微信：<br><img src="__ROOT__/<?php echo ($set["site_logo"]); ?>">
						   			</span>
