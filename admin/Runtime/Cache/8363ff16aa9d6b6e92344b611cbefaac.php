    ...
    <div class="col-tab">
      ...
      <div id="div_setting_1" class="contentList pad-10">
          <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
            ...
            <tr><!--  院长信箱-->
              <th><?php echo L('president_email');?> :</th>
              <td><input type="text" name="site[president_email]" size="80" value="<?php echo ($set["president_email"]); ?>"></td>
            </tr>
            <tr>
              <th><?php echo L('postcode');?> :</th>
              <td><input type="text" name="site[postcode]" size="80" value="<?php echo ($set["postcode"]); ?>"></td>
            </tr>
            <tr>
              <th><?php echo L('duty_web');?> :</th>
              <td><input type="text" name="site[duty_web]" size="80" value="<?php echo ($set["duty_web"]); ?>"></td>
            </tr>
            <tr>
            <tr>
              <th><?php echo L('tel');?> :</th>
              <td><input type="text" name="site[tel]" size="80" value="<?php echo ($set["tel"]); ?>"></td>
            </tr>
            <tr>
              <th><?php echo L('address');?> :</th>
              <td><input type="text" name="site[address]" size="80" value="<?php echo ($set["address"]); ?>"></td>
            </tr>
            <tr>
<!--网站描述 -->
            ...
            <tr>
			<!--关于我们  -->
              <th><?php echo L('about_web');?> :</th>
              <td><textarea rows="10" cols="80" name="site[about_web]"><?php echo ($set["about_web"]); ?></textarea></td>
            </tr> 
			<tr>
