...
<div class="pad-lr-10">
        ...
        <tbody>
            ...
            <div class="explain-col">
				链接分类 :<select name="cate_id" style="width:140px;">
					<option value="" <?php if($cate_id == ''): ?>selected="selected"<?php endif; ?>>--所有分类--</option>
					<?php if(is_array($flink_cate_list)): $i = 0; $__LIST__ = $flink_cate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>" <?php if($cate_id == $val['id']): ?>selected="selected"<?php endif; ?>><?php echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
            	关键字 :
	...
	<form id="myform" name="myform" action="<?php echo u('Flink/del');?>" method="post" onsubmit="return check();">
    <div class="table-list">
      <table width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <!--   <td align="center">
                <?php if($val['img'] != ''): ?><img src="__ROOT__/data/flink/<?php echo ($val["img"]); ?>" height="30px"/><?php endif; ?>            	
            </td> -->
            ...
            <td align="center"><a href="javascript:edit(<?php echo ($val["id"]); ?>,'<?php echo ($val["name"]); ?>')"><em class="blue"><?php echo (L("edit")); ?></em></a></td>
