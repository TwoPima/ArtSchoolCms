...
<div class="pad_10">
<form action="<?php echo u('MilitaryCate/edit');?>" method="post" name="myform" id="myform" >
<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
    ...
    <!-- 英语名称 -->
    <tr>
      <th width="100"><?php echo L('english_name');?>  :</th>
      <td><input type="text" name="english_name" id="english_name" class="input-text" value="<?php echo ($article_cate_info["english_name"]); ?>" size="50"></td>
    </tr>
    <tr>
